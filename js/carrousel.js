class Carousel {
    ...
    createPagination () {
      ...
      let ratioNbr = Math.ceil(this.items.length / this.slidesVisible)
      if(ratioNbr === 1){
        ratioNbr = 0
      }
      ...
      for (let i = 0; i < ratioNbr ; i = i + this.slidesToScroll ) {
    ...
    onWindowResize () {
      ...
      let tablette = window.innerWidth < 1023
      if (mobile !== this.isMobile) {
        this.isMobile = mobile
        this.setStyle()
        this.createPagination ()
        this.moveCallbacks.forEach(cb => cb(this.currentItem))
      }else if(tablette !== this.isTablette){
